...
class Order(models.Model):
  ...
  message = models.TextField(null=True, blank=True, verbose_name="Коментарий к заказу")
...
class OrderItem(models.Model):
  ...
  model = models.CharField(max_length=150, default=None, blank=True, null=True, verbose_name="Модель товара")
